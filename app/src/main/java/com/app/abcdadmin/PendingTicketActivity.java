...
public class PendingTicketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lyt = findViewById(R.id.Def);
        tvPendingCount1 = findViewById(R.id.tvPendingCount1);
        tvOpenedCount1 =  findViewById(R.id.tvOpenedCount1);
        tvClosedCount1 =  findViewById(R.id.tvClosedCount1);
        tvPendingCount2 = findViewById(R.id.tvPendingCount2);
        tvOpenedCount2 =  findViewById(R.id.tvOpenedCount2);
        tvClosedCount2 =  findViewById(R.id.tvClosedCount2);
        tvPendingCount3 = findViewById(R.id.tvPendingCount3);
        tvOpenedCount3 =  findViewById(R.id.tvOpenedCount3);
        tvClosedCount3 =  findViewById(R.id.tvClosedCount3);
        tvPendingCount4 = findViewById(R.id.tvPendingCount4);
        tvOpenedCount4 =  findViewById(R.id.tvOpenedCount4);
        tvClosedCount4 =  findViewById(R.id.tvClosedCount4);
        tvPendingCount5 = findViewById(R.id.tvPendingCount5);
        tvOpenedCount5 = findViewById(R.id.tvOpenedCount5);
        tvClosedCount5 = findViewById(R.id.tvClosedCount5);
